...
### Random Thoughts About the Characterization
...
Then, what if we add a linear combination of some of the vectors in $S$. Formally, let $V=\{\mathbf{v}_{i_1},\dots,\mathbf{v}_{i_m}\} \subset S$. Consider the vector $\mathbf{w}=c_1\mathbf{v}_{i_1}+\dots+c_m\mathbf{v}_{i_m}$.
:::