...
In [Chapter 1.7](../part1/chap1.7.qmd#pivot-columns-and-linear-independence) of this note, we have shown that the non-pivot columns can be written as a linear combination of the prior columns, so we can safely remove them from the set of the columns without changing the span. Thus, we have completely proved [@thm-2-8-13].
:::
